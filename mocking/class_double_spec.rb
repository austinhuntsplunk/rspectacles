...
RSpec.describe 'Class Double' do
    it 'can only impelement class methods that are defined on a class' do 
        ...
        }.to raise_error(RSpec::Mocks::MockExpectationError, /the Deck class does not implement the class method: shuffle/) # 
    end 
    ...
    it 'demonstrates how as_stubbed_const works with class doubles' do
        ...
        expect(fake_deck_class.build).to eq(['Ace of Spades', 'King of Hearts', '10 of Diamonds', '2 of Clubs', '3 of Spades'])
    end
