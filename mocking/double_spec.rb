...
RSpec.describe 'A random double' do
  it 'only allows defined methods to be called' do
    rickybobby = double('Ricky Bobby', on_fire: 'Help me Oprah Winfrey!', catch_phrase: 'Shake and Bake!',
                                       drive_fast: 'If you ain\'t first, you\'re last!')
    ...
    # fly is not defined on the double
    expect do
      rickybobby.fly
    end.to raise_error(RSpec::Mocks::MockExpectationError, /:fly/)
    ...
    allow(cal_naughton_jr).to receive_messages(magic_idea: 'Bunny rabbits!',
                                               steal_rickys_wife: 'I\'m sorry Ricky!', catch_phrase: 'I like to party!')
