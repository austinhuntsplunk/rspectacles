...
class Motorcycle < Vehicle
  def initialize(helmet_included: false, ccs: 500, mileage: 0, make: 'Harley-Davidson', model: 'Street 750',
                 year: 2020, color: 'black', safe: true)
...
class Jeep < Vehicle
  def initialize(off_road_capable: true, top_type: 'soft', mileage: 0, make: 'Jeep', model: 'Wrangler', year: 2020,
                 color: 'green', safe: true)
